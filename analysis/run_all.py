...
- **E1 (primary result):** Holding $p=0.80$ and $N={params_e1_sensitivity.n_jurors}$ fixed, single-window false-claim survival ranges from **{e1_sensitivity_low["false_survival"]:.2f}** at $p_\\mathrm{{detect}}={e1_sensitivity_low["p_detect"]:.2f}$ to **{e1_sensitivity_high["false_survival"]:.2f}** at $p_\\mathrm{{detect}}={e1_sensitivity_high["p_detect"]:.2f}$, and the deterrence threshold $B^*/V$ ranges from **{e1_sensitivity_low["bond_threshold_multiplier"]:.1f}** to **{e1_sensitivity_high["bond_threshold_multiplier"]:.1f}**. Intermediate points: survival is **{e1_sensitivity_010["false_survival"]:.2f}** at $p_\\mathrm{{detect}}={e1_sensitivity_010["p_detect"]:.2f}$ ($B^*/V={e1_sensitivity_010["bond_threshold_multiplier"]:.1f}$), **{e1_sensitivity_035["false_survival"]:.2f}** at $p_\\mathrm{{detect}}={e1_sensitivity_035["p_detect"]:.2f}$ ($B^*/V={e1_sensitivity_035["bond_threshold_multiplier"]:.1f}$), and **{e1_sensitivity_050["false_survival"]:.2f}** at $p_\\mathrm{{detect}}={e1_sensitivity_050["p_detect"]:.2f}$ ($B^*/V={e1_sensitivity_050["bond_threshold_multiplier"]:.1f}$).
