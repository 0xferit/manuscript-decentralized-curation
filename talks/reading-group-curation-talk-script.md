...
A known limitation: the mechanism resists small colluding minorities, but our simulations show it degrades when a coordinated bloc exceeds roughly 15 to 20 percent of drafted stake. Below that threshold, honest reporting is stable; above it, a coordinating bloc can bend the relevance signal. This constraint is quantified in the paper but not yet solved.
